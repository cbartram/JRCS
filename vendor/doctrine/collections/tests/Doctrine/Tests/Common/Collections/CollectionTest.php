...
class CollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->collection[0] = 'tests';
        $this->assertTrue($this->collection->contains('tests'));
    }

    public function testSearch()
    {
        $this->collection[0] = 'tests';
        $this->assertEquals(0, $this->collection->indexOf('tests'));
    }

    public function testGet()
    {
        $this->collection[0] = 'tests';
        $this->assertEquals('tests', $this->collection->get(0));
    }
