 ...
 *
 * This class tests a large portion of all locale specific providers. It does not tests the entire stack, because each
 * locale specific provider (can) has specific implementations. The goal of this tests is to tests the common denominator
