...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
     ...
     * This tests will fail with "Not enough arguments." if broken
     */
    ...
    public function testRunWithDispatcherAddingInputOptions()
    {
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array('command' => 'foo', '--extra' => 'some tests value'));

        $this->assertEquals('some tests value', $extraValue);
    }
